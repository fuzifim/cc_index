...
?>
<?php echo Theme::asset()->container('footer')->usePath()->add('jquery', 'js/jquery-1.11.1.min.js', array('core-script')); ?>

<?php echo Theme::asset()->container('footer')->usePath()->add('jquery-migrate', 'js/jquery-migrate-1.2.1.min.js', array('core-script')); ?>

<?php echo Theme::asset()->container('footer')->usePath()->add('bootstrap', 'js/bootstrap.min.js', array('core-script')); ?>

<?php echo Theme::asset()->container('footer')->usePath()->add('modernizr', 'js/modernizr.min.js', array('core-script')); ?>

<?php echo Theme::asset()->container('footer')->usePath()->add('toggles', 'js/toggles.min.js', array('core-script')); ?>

<?php echo Theme::asset()->container('footer')->usePath()->add('jquery.cookies', 'js/jquery.cookies.js', array('core-script')); ?>

<?php echo Theme::asset()->container('footer')->usePath()->add('bootstrap-wizard', 'js/bootstrap-wizard.min.js', array('core-script')); ?>

<?php echo Theme::asset()->container('footer')->usePath()->add('select2.min', 'js/select2.min.js', array('core-script')); ?>

<?php echo Theme::asset()->container('footer')->usePath()->add('jquery.validate.min', 'js/jquery.validate.min.js', array('core-script')); ?>

<?php echo Theme::asset()->container('footer')->usePath()->add('jquery.gritter.min', 'js/jquery.gritter.min.js', array('core-script')); ?>

<section>
<div class="mainpanel">
<?php echo Theme::partial('headerbar', array('title' => 'Header')); ?>
			...
			<div class="col-md-6">
				<div class="formRegisterChannel mb10">
					...
					<div id="validationWizard" class="basic-wizard" style="position:relative;">
						...
						<form class="form" id="form1" method="post" action="<?php echo e(route('channel.create.request',$channel['domain']->domain)); ?>">
							<div class="tab-content">
								<div class="tab-pane" id="vtab1">
									...
									<div class="form-group">
										<div class="input-group">
										  <input type="text" name="channelDomain" id="channelDomain" class="form-control" value="<?php if(!empty($channelDomain)): ?><?php echo $channelDomain; ?><?php endif; ?>" maxlength="30" placeholder="Nhập địa chỉ tên miền" required >
										  <span class="input-group-addon">.cungcap.net</span>
										</div>
										<code id="changeDomain"><?php if(!empty($channelDomain)): ?>http://<?php echo $channelDomain; ?>.cungcap.net <?php endif; ?></code>
									...
									?>
									<div class="form-group">
										<input type="text" id="channelName" name="channelName" value="<?php if(!empty($channelInfo['channelName'])): ?><?php echo $channelInfo['channelName']; ?><?php endif; ?>" class="form-control" placeholder="Tên website Vd: Cung cấp đậu phộng..." required />
									</div>
									<div class="form-group">
										<input type="text" name="channelDescription" value="<?php if(!empty($channelInfo['channelDescription'])): ?><?php echo $channelInfo['channelDescription']; ?><?php endif; ?>" class="form-control" placeholder="Mô tả website, cửa hàng..." required />
									</div>
								</div>
								<div class="tab-pane" id="vtab2">
									...
									<div class="row mb5">
										<div class="col-sm-12">
											<div class="input-group">
												...
												<input type="text" name="channelAddress" value="<?php if(!empty($channelRegion['channelAddress'])): ?><?php echo $channelRegion['channelAddress']; ?><?php endif; ?>" class="form-control" placeholder="Địa chỉ đường, số nhà công ty, cửa hàng..." required />
											</div>
									...
									<div class="row mb5">
										<div class="col-sm-6">
											<input type="hidden" name="idRegion" value="<?php if(!empty($channelRegion['channelRegion'])): ?><?php echo $channelRegion['channelRegion']; ?><?php else: ?><?php echo e($channel['info']->channelJoinRegion->region->id); ?><?php endif; ?>">
											<input type="hidden" name="regionIso" value="<?php echo e(mb_strtolower($channel['info']->channelJoinRegion->region->iso)); ?>">
											<div class="addSelectRegion"></div>
											<div class="mb10"></div>
										</div>
										<div class="col-sm-6">
											<input type="hidden" name="idSubRegion" value="<?php if(!empty($channelRegion['channelSubRegion'])): ?><?php echo $channelRegion['channelSubRegion']; ?><?php else: ?><?php echo e($channel['info']->channelJoinSubRegion->subregion->id); ?><?php endif; ?>">
								...
								<div class="tab-pane" id="vtab3">
									<div class="form-group">
										<div class="input-group">
											...
											<input placeholder="Tên của bạn" id="fullName" name="fullName" value="<?php if(!empty($sessionChannel['channelFullName'])): ?><?php echo $sessionChannel['channelFullName']; ?><?php elseif(Auth::check()): ?><?php echo e(Auth::user()->name); ?><?php endif; ?>" type="text" class="form-control" required>
										</div>
									...
									<div class="row mb5">
										<div class="col-sm-6">
											<div class="input-group">
												...
												<input type="phone" class="form-control" name="channelPhone" value="<?php if(!empty($sessionChannel['channelPhone'])): ?><?php echo $sessionChannel['channelPhone']; ?><?php elseif(Auth::check()): ?><?php echo e(Auth::user()->phone); ?><?php endif; ?>" placeholder="Số điện thoại..." required>
											</div>
										...
										<div class="col-sm-6">
											<div class="input-group">
												...
												<input type="email" class="form-control" name="channelEmail" value="<?php if(!empty($sessionChannel['channelEmail'])): ?><?php echo $sessionChannel['channelEmail']; ?><?php elseif(Auth::check()): ?><?php echo e(Auth::user()->email); ?><?php endif; ?>" placeholder="Địa chỉ email..." required>
											</div>
...
<div class="panelCountSite mb5">
	<div class="container">
		<h1 class="text-center"><?php echo e(Site::price(count($getChannelAll))); ?> website</h1>
		<h4 class="text-center"><?php echo e(Site::price(count($getUserAll))); ?> thành viên đăng ký</h4>
	</div>
</div>
<?
	$dependencies = array(); 
